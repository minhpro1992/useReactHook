...
const SERVICES_TAB = "service";
const STATISTICS_TAB = "statistics";

const getClassName = (tab: string, selectedTab: string) => {
  if (tab === selectedTab)
    return `inline-block p-4 text-blue-600 rounded-tl-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-blue-500`;
  return "inline-block p-4 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-gray-300";
};

export const Introduction: FC = () => {
  const [selectedTab, setSelectedTab] = useState<string>(ABOUT_TAB);
    ...
    <>
      <div className="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <ul
          ...
          role="tablist"
        >
          {[ABOUT_TAB, SERVICES_TAB, STATISTICS_TAB].map((tab, _) => (
            <li className="mr-2" key={tab}>
              <button
                ...
                className={getClassName(tab, selectedTab)}
        ...
        <div id="defaultTabContent">
          ...
          <div
            className={`${
              selectedTab === SERVICES_TAB ? "" : "hidden"
            } p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800`}
            id="services"
            role="tabpanel"
          ...
          <div
            className={`${
              selectedTab === STATISTICS_TAB ? "" : "hidden"
            }  p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800`}
            id="statistics"
            role="tabpanel"
